...
public class MainTest extends TestBenchTestCase {
    ...
    private void openTestUrl() {
        getDriver().get("http://localhost:8080/VaadinPoc");
    }
    ...
    public void testClickButton() throws Exception {
        ...
        // Click the button
        TableElement table = $(TableElement.class).caption("articleTable").first();
        assertEquals(table.getRow(0).getCell(0).getText(),"article 1");
/*
